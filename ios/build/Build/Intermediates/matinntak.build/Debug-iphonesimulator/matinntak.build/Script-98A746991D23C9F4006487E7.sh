#!/bin/sh
# https://github.com/calabash/calabash-ios-example/blob/master/bin/xcode-build-phase/stage-LPSimpleExample-products.sh
#!/usr/bin/env bash
...
info "Skipping staging to Products; only necessary for Calabash configuration"
